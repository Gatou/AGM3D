...
from libs.editor.ui.sourcesdock.Ui_SourcesDock import Ui_SourcesDock

class SourcesDock(AbstractDock):
    ...
    def setup_ui(self):
        self.ui = Ui_SourcesDock()
        self.ui.setupUi(self)
    
    def refresh(self):
        self.ui.tree.set_relative_root_path("Sources")
